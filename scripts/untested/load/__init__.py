...
- load_crypto_orthologs.py: Load OrthoMCL ortholog clusters (Cryptococcus)
...
- load_genome.py: Load genome features from GFF/GenBank/EMBL files
...
- load_mito_contigs.py: Load mitochondrial contig sequences from FASTA
...
- load_ortholog_pairs.py: Load pairwise ortholog pairs (InParanoid)
...
- update_trna_names.py: Update tRNA names and add GO annotations
...
Usage:
    ...
    python scripts/load/load_crypto_orthologs.py --help
    ...
    python scripts/load/load_genome.py --help
    ...
    python scripts/load/load_mito_contigs.py --help
    ...
    python scripts/load/load_ortholog_pairs.py --help
    ...
    python scripts/load/update_trna_names.py --help
"""
