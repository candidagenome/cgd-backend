...
OUT = glob.glob("/data/HTS/repeat_te/rm_denovo_C_tropicalis/*.out")[0]
FAM = "/data/HTS/repeat_te/rmodel_C_tropicalis/CTROP-families.fa"
TES = "/data/HTS/repeat_te/CTROP_tesorter.cls.tsv"
TSV = "/data/HTS/repeat_te/C_tropicalis_repeat_candidates.tsv"
FSUM = "/data/HTS/repeat_te/C_tropicalis_repeat_family_summary.tsv"
