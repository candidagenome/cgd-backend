...
class Alias(Base):
    ...
    alias_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an alias. Oracle sequence generated number.')
...
class Author(Base):
    ...
    author_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an author. Oracle sequence generated number.')
...
class Book(Base):
    ...
    book_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a book. Oracle sequence generated number.')
    ...
    total_pages: Mapped[Optional[int]] = mapped_column(Integer, comment='Total number of pages in the book.')
...
class Code(Base):
    ...
    code_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a code.  Oracle sequence generated number.')
...
class Colleague(Base):
    ...
    colleague_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a colleague. Oracle sequence generated number.')
...
class Dbuser(Base):
    ...
    dbuser_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a database user.  Oracle sequence generated number.')
...
class Dbxref(Base):
    ...
    dbxref_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Unique identifier for an database cross reference. Oracle sequence generated number.')
...
class DeleteLog(Base):
    ...
    delete_log_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a deleted row.  Oracle sequence generated number.')
    tab_name: Mapped[str] = mapped_column(VARCHAR(30), nullable=False, comment='Table name.')
    primary_key: Mapped[int] = mapped_column(Integer, nullable=False, comment='Primary key of the row deleted.')
...
class Experiment(Base):
    ...
    experiment_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an experiment.  Oracle sequence generated number.')
...
class ExptProperty(Base):
    ...
    expt_property_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an experiment property. Oracle sequence generated number.')
...
class Go(Base):
    ...
    go_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier assigned to a goid. Oracle sequence generated number.')
    goid: Mapped[int] = mapped_column(Integer, nullable=False, comment='GO number assigned by GO software.')
...
class GoSynonym(Base):
    ...
    go_synonym_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a GO synonym. Oracle sequence generated number.')
...
class HomologyGroup(Base):
    ...
    homology_group_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a homology group.  Oracle generated sequence number.')
...
class Interaction(Base):
    ...
    interaction_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an interaction. Oracle generated sequence number.')
...
class Journal(Base):
    ...
    journal_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a journal. Oracle sequence generated number.')
...
class Keyword(Base):
    ...
    keyword_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a keyword. Oracle sequence generated number.')
...
class Note(Base):
    ...
    note_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a note. Oracle generated sequence number.')
...
class Paragraph(Base):
    ...
    paragraph_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a paragraph. Oracle sequence generated number.')
...
class Phenotype(Base):
    ...
    phenotype_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a phenotype. Oracle sequence generated number.')
...
class RefBad(Base):
    ...
    pubmed: Mapped[int] = mapped_column(Integer, primary_key=True, comment='PubMed identifier for a reference that should not be associated with the database or a given table record.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was first entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Userid of the person who entered the record into the database.')
...
class RefTemp(Base):
    ...
    ref_temp_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a temporary reference. Oracle sequence generated number.')
    pubmed: Mapped[int] = mapped_column(Integer, nullable=False, comment='PMID of the reference from NCBI.')
...
class RefType(Base):
    ...
    ref_type_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a reference type. Oracle generated sequence number.')
...
class RefUnlink(Base):
    ...
    ref_unlink_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an unlinked reference. Oracle sequence generated number.')
    pubmed: Mapped[int] = mapped_column(Integer, nullable=False, comment='PubMed identifier for a reference that should not be associated with a given row in the database.')
    ...
    primary_key: Mapped[int] = mapped_column(Integer, nullable=False, comment='Primary key of the row that should be unlinked from the reference')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
...
class TabRule(Base):
    ...
    tab_rule_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a table rule. Oracle generated sequential number.')
...
class Taxonomy(Base):
    ...
    taxon_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a taxonomy term from NCBI.')
...
class UpdateLog(Base):
    ...
    update_log_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an entry in the update log. Oracle sequence generated number.')
    ...
    primary_key: Mapped[int] = mapped_column(Integer, nullable=False, comment='Primary key of the row that was updated.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
...
class Url(Base):
    ...
    url_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier assigned to each URL.  Oracle sequence generated number')
...
class WebMetadata(Base):
    ...
    web_metadata_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the web_metadata table. Oracle sequence generated number.')
...
class BlastHit(Base):
    ...
    blast_hit_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a blast hit. Oracle generated sequence number.')
    ...
    length: Mapped[int] = mapped_column(Integer, nullable=False, comment='The length of the sequence in amino acids.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    taxon_id: Mapped[Optional[int]] = mapped_column(Integer, comment='Unique identifier for a taxonomy term assigned by NCBI. Foreign key to the taxonomy table.')
...
class ColRule(Base):
    ...
    col_rule_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a column rule. Oracle generated sequential number.')
...
class CollKw(Base):
    ...
    coll_kw_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the coll_kw table. Oracle sequence generated number.')
    colleague_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague. Foreign key to the colleague table.')
    keyword_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a keyword. Foreign key to the keyword table.')
...
class CollRelationship(Base):
    ...
    coll_relationship_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a colleague relationship. Oracle sequence generated number.')
    colleague_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague who is an associate of another colleague. Foreign key to the colleague table.')
    associate_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague who is an associate of another colleague. Foreign key to the colleague table.')
...
class CollUrl(Base):
    ...
    coll_url_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the coll_url table. Oracles sequence generated number.')
    colleague_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague. Foreign key to the colleague table.')
    url_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Unique identifier assigned to each URL.  Foreign key to the url table.')
...
class ColleagueRemark(Base):
    ...
    colleague_remark_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a colleague remark. Oracle sequence generated number.')
    colleague_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague. Foreign key to the colleague table.')
...
class Cv(Base):
    ...
    cv_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a controlled vocabulary. Oracle sequence generated number.')
    cv_name: Mapped[str] = mapped_column(VARCHAR(40), nullable=False, comment='Unique name of the controlled vocabulary.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    url_no: Mapped[Optional[int]] = mapped_column(Integer, comment='Assigned unique identifier assigned to each URL.  Foreign key to the URL table.')
...
class DbxrefHomology(Base):
    ...
    dbxref_homology_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an external ortholog. Oracle generated sequence number.')
    dbxref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a dbxref. FK to the DBXREF table.')
    homology_group_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a homology group. FK to the HOMOLOGY_GROUP table.')
...
class DbxrefUrl(Base):
    ...
    dbxref_url_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the dbxref_url table. Oracle sequence generated number.')
    dbxref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an database cross reference. Foreign key to the dbxref table.')
    url_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned for a URL.  Foreign key to the url table.')
...
class ExptExptprop(Base):
    ...
    expt_exptprop_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the expt_exptprop table. Linking table between the experiment and expt_property tables.')
    expt_property_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an experiment property. FK to the expt_property table.')
    experiment_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an experiment.  FK to the experiment table.')
...
class GoGosyn(Base):
    ...
    go_gosyn_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the go_gosyn table. Oracle sequence generated number.')
    go_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned to a goid. Foreign key to the go table.')
    go_synonym_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a GO synonym. Foreign key to the go_synonym table.')
...
class GoPath(Base):
    ...
    go_path_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a go path. Oracle generated sequence number.')
    ancestor_go_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned to the ancestor goid. Foreign key to the go table.')
    child_go_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned for a child goid. Foreign key to the go table.')
    generation: Mapped[int] = mapped_column(Integer, nullable=False, comment='The number of generations between the parent and child term; for example, for a  grandchild:grandparent relationship, the generation = 2.')
...
class GoSet(Base):
    ...
    go_set_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a go set. Oracle sequence generated number.')
    go_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned to a goid. Foreign key to the go table.')
...
class InteractPheno(Base):
    ...
    interact_pheno_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the interact_pheno. Oracle sequence generated number.')
    interaction_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an interaction. Foreign key to the interaction table.')
    phenotype_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Unique identifier for a phenotype.  Foreign key to the phenotype table.')
...
class NoteLink(Base):
    ...
    note_link_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a note link. Oracle generated sequence number.')
    note_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a note. Foreign key to the note table.')
    tab_name: Mapped[str] = mapped_column(VARCHAR(30), nullable=False, comment='The table name of the row to which the note refers.')
    primary_key: Mapped[int] = mapped_column(Integer, nullable=False, comment='The primary key of the row to which the note refers.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
...
class PdbSequence(Base):
    ...
    pdb_sequence_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a PDB sequence. Oracle sequence generated number.')
    ...
    sequence_length: Mapped[int] = mapped_column(Integer, nullable=False, comment='Length of the sequence.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    taxon_id: Mapped[Optional[int]] = mapped_column(Integer, comment='Unique identifier for a taxonomy term assigned by NCBI. Foreign key to the taxonomy table.')
...
class Reference(Base):
    ...
    reference_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a reference. Oracle sequence generated number.')
    ...
    year: Mapped[int] = mapped_column(Integer, nullable=False, comment='Year of publication or communication.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Userid of the person who entered the record into the database.')
    ...
    pubmed: Mapped[Optional[int]] = mapped_column(Integer, comment='PubMed ID from NCBI.')
    date_published: Mapped[Optional[str]] = mapped_column(VARCHAR(40), comment='Date the reference was published.')
    date_revised: Mapped[Optional[int]] = mapped_column(Integer, comment='Date the reference was revised.')
    ...
    journal_no: Mapped[Optional[int]] = mapped_column(Integer, comment='Assigned unique identifier for a journal. Foreign key to the journal table.')
    book_no: Mapped[Optional[int]] = mapped_column(Integer, comment='Assigned unique identifier for a book. Foreign key to the book table.')
...
class TaxRelationship(Base):
    ...
    tax_relationship_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a taxonomy relationship. Oracle sequence generated number.')
    parent_taxon_id: Mapped[int] = mapped_column(Integer, nullable=False, comment='Primary key, unique identifier for a taxonomy term; ID from NCBI, not an Oracle-generated sequence number.')
    child_taxon_id: Mapped[int] = mapped_column(Integer, nullable=False, comment='Primary key, unique identifier for a taxonomy term; ID from NCBI, not an Oracle-generated sequence number.')
    generation: Mapped[int] = mapped_column(Integer, nullable=False, comment='The generation between the parent and the child term.  For example, a direct parent:child relationship would be generation = 1, while a grandparent:grandchild relationship would be generation = 2.')
...
class TaxSynonym(Base):
    ...
    tax_synonym_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a taxonomy synonym.  Oracle sequence generated number.')
    taxon_id: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a taxonomy term from NCBI. Foreign key to the taxonomy table.')
...
class UrlHomology(Base):
    ...
    url_homology_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the URL_HOMOLOGY table. Oracle generated sequence number.')
    url_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a URL. FK to the URL table.')
    homology_group_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a homology group. FK to the HOMOLOGY_GROUP table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
...
class WebDisplay(Base):
    ...
    web_display_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a web display location. Oracle sequence generated number.')
    url_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned to each URL.  Foreign key to the url table.')
...
class Organism(Base):
    ...
    organism_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an organism. Oracle generated sequence number.')
    ...
    taxon_id: Mapped[int] = mapped_column(Integer, nullable=False, comment='The NCBI taxon_id if available for this organism. Link to the TAXONOMY table.')
    ...
    organism_order: Mapped[int] = mapped_column(Integer, nullable=False, comment='Display order of the organism within species and/or within strains.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    parent_organism_no: Mapped[Optional[int]] = mapped_column(Integer, comment='Parent organism_no for this organism (e.g., parent_organism_no for a species is the genus organism_no). FK to the ORGANISM table.')
...
class Abstract(Reference_):
    ...
    reference_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
...
class AuthorEditor(Base):
    ...
    author_editor_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for each author or editor for a reference. Oracle sequence generated number.')
    author_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an author. Foreign key to the author table.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
    author_order: Mapped[int] = mapped_column(Integer, nullable=False, comment='Order in which an author is in the list of authors for a particular reference.')
...
class CvTerm(Base):
    ...
    cv_term_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a controlled vocabulary term. Oracle sequence generated number.')
    cv_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a controlled vocabulary. Oracle sequence generated number.')
...
class DbxrefRef(Base):
    ...
    dbxref_ref_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the dbxref_ref table. Oracle sequence generated number.')
    dbxref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an database cross reference. Foreign key to the dbxref table.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
...
class Feature(Base):
    ...
    feature_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature. Oracle sequence generated number.')
    organism_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an organism. FK to the ORGANISM table.')
...
class GenomeVersion(Base):
    ...
    genome_version_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a genome version. Oracle sequence generated number.')
    genome_version: Mapped[str] = mapped_column(VARCHAR(40), nullable=False, comment='The version of the genome.')
    organism_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Organism associated with this genome version. FK to the ORGANISM table.')
...
class PdbAlignment(Base):
    ...
    pdb_alignment_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a PDB alignment. Oracle sequence generated number.')
    query_seq_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the query sequence. Foreign key to the pdb_sequence table.')
    target_seq_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a target sequence. Foreign key to the pdb_sequence table.')
    ...
    query_align_start_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Query alignment start basepair coordinate.')
    query_align_stop_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Query alignment stop basepair coordinate.')
    target_align_start_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Target alignment start basepair coordinate.')
    target_align_stop_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Target alignment stop basepair coordinate.')
...
class RefLink(Base):
    ...
    ref_link_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for an associated reference. Oracle generated sequence number.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
    tab_name: Mapped[str] = mapped_column(VARCHAR(30), nullable=False, comment='Name of table linked to a reference.')
    primary_key: Mapped[int] = mapped_column(Integer, nullable=False, comment='Primary key for the row linked to a reference.')
...
class RefProperty(Base):
    ...
    ref_property_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a reference property. Oracle sequence generated number.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
...
class RefReftype(Base):
    ...
    ref_reftype_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the ref_reftype table. Oracle sequence generated number.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
    ref_type_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a ref_type. Foreign key to the ref_type table.')
...
class RefRelationship(Base):
    ...
    ref_relationship_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a reference relationship. Oracle sequence generated number.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
    related_ref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the related reference. Foreign key to the reference table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was first entered into the database.')
...
class RefUrl(Base):
    ...
    ref_url_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the ref_url table. Oracle sequence generated number.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference. Foreign key to the reference table.')
    url_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for each URL.  Foreign key to the url table.')
...
class BlastAlignment(Base):
    ...
    blast_alignment_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a blast alignment. Oracle generated sequence number.')
    query_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier of the query sequence. Foreign key to the feature table.')
    target_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a target sequence. Foreign key to homolog table.')
    ...
    query_start_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Start coordinate of where the alignment begins for the query sequence.')
    query_stop_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Stop coordinate of where the alignment begins for the query sequence.')
    target_start_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Start coordinate of where the alignment begins for the target sequence.')
    target_stop_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Stop coordinate of where the alignment begins for the target sequence.')
...
class CollFeat(Base):
    ...
    coll_feat_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a colleague-feature relationship.  Oracle sequence generated number.')
    colleague_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague. Foreign key to the colleague table.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
...
class CvtermDbxref(Base):
    ...
    cvterm_dbxref_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier to link the cvterm and dbxref tables. Oracle sequence generated number.')
    cv_term_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a controlled vocabulary term. Foreign key to the cv_term table.')
    dbxref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Unique identifier for an database cross reference. Foreign key to the dbxref table.')
...
class CvtermGroup(Base):
    ...
    cvterm_group_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a group of controlled vocabulary terms.  Oracle sequence generated number.')
...
class CvtermPath(Base):
    ...
    cvterm_path_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a cv term path.  Oracle sequence generated number.')
    child_cv_term_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a child controlled vocabulary term. Foreign key to the cv_term table.')
    ancestor_cv_term_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the ancestor controlled vocabulary term. Foreign key to the cv_term table.')
    generation: Mapped[int] = mapped_column(Integer, nullable=False, comment='The number of generations between the parent and child term; for example, for a grandchild:grandparent relationship, the generation = 2.')
...
class CvtermRelationship(Base):
    ...
    cvterm_relationship_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier')
    child_cv_term_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a child/subject controlled vocabulary term. Foreign key to the cv_term table.')
    parent_cv_term_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a parent controlled vocabulary term. Foreign key to the cv_term table.')
...
class CvtermSynonym(Base):
    ...
    cvterm_synonym_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a controlled vocabulary term synonym.  Oracle sequence generated number.')
    cv_term_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a controlled vocabulary term. Oracle sequence generated number.')
...
class DbxrefFeat(Base):
    ...
    dbxref_feat_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the dbxref_feat table. Oracle sequence generated number.')
    dbxref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an database cross reference. Foreign key to the dbxref table.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
...
class FeatAlias(Base):
    ...
    feat_alias_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the feat_alias table. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Oracle sequence generated number.')
    alias_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an alias. Oracle sequence generated number.')
...
class FeatHomology(Base):
    ...
    feat_homology_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the FEAT_HOMOLOGY table. Oracle generated sequence number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. FK to the FEATURE table.')
    homology_group_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a homology group. FK to the HOMOLOGY_GROUP table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
...
class FeatInteract(Base):
    ...
    feat_interact_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature interaction. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    interaction_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an feature interaction. Foreign key to the interaction table.')
...
class FeatPara(Base):
    ...
    feat_para_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature-paragraph association. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    paragraph_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a paragraph. Foreign key to the paragraph table.')
    paragraph_order: Mapped[int] = mapped_column(Integer, nullable=False, comment='Order of the paragraphs associated with the feature.')
...
class FeatProperty(Base):
    ...
    feat_property_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the feat_property table. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Unique identifier for a feature. Foreign key to the feature table.')
...
class FeatRelationship(Base):
    ...
    feat_relationship_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature relationship. Oracle sequence generated number.')
    parent_feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the parent feature. Foreign key to the feature table.')
    child_feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the child feature. Foreign key to the feature table..')
    relationship_type: Mapped[str] = mapped_column(VARCHAR(40), nullable=False, comment='The type of feature relationship. Coded.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    rank: Mapped[Optional[int]] = mapped_column(Integer, comment='The rank or order of the feature.')
...
class FeatUrl(Base):
    ...
    feat_url_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the feat_url table. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    url_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned for each URL.  Foreign key to the url table.')
...
class GeneReservation(Base):
    ...
    gene_reservation_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a gene reservation. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
...
class GoAnnotation(Base):
    ...
    go_annotation_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a go annoation. Oracle sequence generated number.')
    go_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier assigned to a goid. Foreign key to the go table.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
...
class PdbAlignmentSequence(Base):
    ...
    pdb_alignment_sequence_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a PDB aligned sequence. Oracle sequence generated number.')
    pdb_alignment_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a PDB alignment.  Foreign key to the PDB_ALIGNMENT table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
...
class PhenoAnnotation(Base):
    ...
    pheno_annotation_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature-phenotype annotation. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    phenotype_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a phenotype. Foreign key to the phenotype table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Userid of the person who entered the record into the database.')
    experiment_no: Mapped[Optional[int]] = mapped_column(Integer, comment='Unique identifier for an experiment. Foreign key to the experiment table.')
...
class ProteinInfo(Base):
    ...
    protein_info_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for protein information. Oracle generated sequence number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    molecular_weight: Mapped[Optional[int]] = mapped_column(Integer, comment='Molecular weight of the protein.')
    ...
    protein_length: Mapped[Optional[int]] = mapped_column(Integer, comment='Length of the protein.')
    ...
    ala: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of alanines in the protein.')
    arg: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of arginines in the protein.')
    asn: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of asparagines in the protein.')
    asp: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of aspartic acids in the protein.')
    cys: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of cysteines in the protein.')
    gln: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of glutamines in the protein.')
    glu: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of glutamic acids in the protein.')
    gly: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of glycines in the protein.')
    his: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of histidines in the protein.')
    ile: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of isoleucines in the protein.')
    leu: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of leucines in the protein.')
    lys: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of lycines in the protein.')
    met: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of methionines in the protein.')
    phe: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of phenylalanines in the protein.')
    pro: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of prolines in the protein.')
    thr: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of threonines in the protein.')
    ser: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of serines in the protein.')
    trp: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of tryptophans in the protein.')
    tyr: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of tyrosines in the protein.')
    val: Mapped[Optional[int]] = mapped_column(Integer, comment='Number of valines in the protein.')
...
class RefpropFeat(Base):
    ...
    refprop_feat_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a row in the refprop_feat table.  Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    ref_property_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a reference property. Foreign key to the ref_property table.')
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was first entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who first entered the record into the database.')
...
class Seq(Base):
    ...
    seq_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature sequence. Oracle generated sequence number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a feature. Foreign key to the feature table.')
    genome_version_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a genome version. FK to theGENOME_VERSION table.')
    ...
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    seq_length: Mapped[int] = mapped_column(Integer, nullable=False, comment='The sequence length, in nucleotide or amino acid residues.')
...
class CollGeneres(Base):
    ...
    coll_generes_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a colleague-gene_reservation relationship.  Oracle sequence generated number.')
    colleague_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a colleague.  Foreign key to the colleague table.')
    gene_reservation_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a gene reservation. Foreign key to the gene_reservation table.')
...
class FeatLocation(Base):
    ...
    feat_location_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a feature sequence annotation. Oracle sequence generated number.')
    feature_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for this feature location. Foreign key to the feature table.')
    root_seq_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the root sequence (e.g., chromosome) associated with this feature location. Foreign key to the seq table.')
    ...
    start_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Start coordinate of the feature location.')
    stop_coord: Mapped[int] = mapped_column(Integer, nullable=False, comment='Stop coordinate of the feature location.')
    ...
    date_created: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('SYSDATE '), comment='Date the record was entered into the database.')
    created_by: Mapped[str] = mapped_column(VARCHAR(12), nullable=False, server_default=text('SUBSTR(USER,1,12) '), comment='Person who entered the record into the database.')
    seq_no: Mapped[Optional[int]] = mapped_column(Integer, comment='The sequence associated with this feature location.  Foreign key to the seq table.')
...
class GoRef(Base):
    ...
    go_ref_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a GO reference association. Oracle generated sequence number.')
    reference_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a  reference. Foreign key to the reference table.')
    go_annotation_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a go annoation. Foreign key to the go_annotation table.')
...
class ProteinDetail(Base):
    ...
    protein_detail_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a protein detail. Oracle generated sequence number.')
    protein_info_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for protein information. Oracle generated sequence number.')
    ...
    start_coord: Mapped[Optional[int]] = mapped_column(Integer, comment='The start coordinate in terms of the amino acid sequence, relevant to the additional information.')
    stop_coord: Mapped[Optional[int]] = mapped_column(Integer, comment='The stop coordinate in terms of the amino acid sequence, relevant to the additional information.')
...
class SeqChangeArchive(Base):
    ...
    seq_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for the old DNA sequence. Foreign key to the seq table.')
...
class GoQualifier(Base):
    ...
    go_qualifier_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for a go qualifier. Oracle sequence generated number.')
    go_ref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a GO reference association. Foreign key to the go_ref table.')
...
class GorefDbxref(Base):
    ...
    goref_dbxref_no: Mapped[int] = mapped_column(Integer, primary_key=True, comment='Assigned unique identifier for go supporting evidence.  Oracle sequence generated number.')
    go_ref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for a GO reference association. Foreign key to the go_ref table.')
    dbxref_no: Mapped[int] = mapped_column(Integer, nullable=False, comment='Assigned unique identifier for an database cross reference. Foreign key to dbxref table.')
